...
// name: 시퀀스 제너레이터의 명칭 지정
// sequenceName: 실제 DB에 생성될 시퀀스의 명칭 지정
// initialValue: 시퀀스의 시작 값 지정 (초기값)
// allocationSize: 시퀀스가 몇 씩 증가할지 지정 (사이즈 할당)
@SequenceGenerator(
...
public class BoardTest {
	...
	@Id
	// 키 값 생성 전략
	// GeneratedValue: generationValue 어노테이션을 선언하지 않으면 키 값을 직접 할당
	// GeneratedValue의 속성
	// AUTO: 기본값, 데이터베이스에서 알아서 키 값 할당.
	// IDENTITY: AUTO_INCREMENT를 사용하여 키 값을 할당.
	// SEQUENCE: 시퀀스를 생성하여 키 값을 할당. 항상 시퀀스 속성은 제너레이터와 항상 같이 사용되어야 한다
